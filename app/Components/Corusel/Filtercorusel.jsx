...
const Filtercorusel = () => {
  ...
  return (
    <section className="bg-[#f6ecdf] px-4 py-3 sm:py-6 md:py-10">
      <div className="flex gap-2 overflow-x-auto px-4 py-2 md:justify-center">
        <div
          className={`p-2 border font-bold cursor-pointer ${
            selectedTab === "latest" ? "bg-black text-white" : ""
          }`}
        ...
        <div
          className={`p-2 border font-bold cursor-pointer ${
            selectedTab === "bestsellers" ? "bg-black text-white" : ""
          }`}
        ...
        <div
          className={`p-2 border font-bold cursor-pointer ${
            selectedTab === "sale" ? "bg-black text-white" : ""
          }`}
